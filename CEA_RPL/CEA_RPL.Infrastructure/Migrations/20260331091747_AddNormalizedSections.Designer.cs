...
namespace CEA_RPL.Infrastructure.Migrations
{
    ...
    [Migration("20260331091747_AddNormalizedSections")]
    partial class AddNormalizedSections
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CEA_RPL.Domain.Entities.PaperPublished", b =>
                {
                    ...
                    b.ToTable("PaperPublishedEntries");
                });
            ...
            modelBuilder.Entity("CEA_RPL.Domain.Entities.ReviewSubmit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CEA_RPL.Domain.Entities.PaperPublished", b =>
                {
                    b.HasOne("CEA_RPL.Domain.Entities.Applicant", "Applicant")
                        .WithMany("PaperPublishedEntries")
                        .HasForeignKey("ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CEA_RPL.Domain.Entities.ReviewSubmit", b =>
                {
                    b.HasOne("CEA_RPL.Domain.Entities.Applicant", "Applicant")
                        .WithOne("ReviewSubmit")
                        .HasForeignKey("CEA_RPL.Domain.Entities.ReviewSubmit", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CEA_RPL.Domain.Entities.Applicant", b =>
                {
                    ...
                    b.Navigation("PaperPublishedEntries");
